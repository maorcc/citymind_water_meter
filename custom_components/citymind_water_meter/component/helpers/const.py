...
ENDPOINT_CONSUMPTION_DAILY = f"{ENDPOINT_CONSUMPTION_NEW}/daily/lastbillingCycle/[PH_METER_ID]/[PH_YESTERDAY]/[PH_TODAY]"
ENDPOINT_CONSUMPTION_MONTHLY = f"{ENDPOINT_CONSUMPTION_NEW}/monthly/[PH_METER_ID]/[PH_CURRENT_MONTH]/[PH_LAST_DAY_MONTH]"
